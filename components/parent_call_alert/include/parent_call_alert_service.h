...
#define PARENT_CALL_ALERT_SERVICE_DEFAULT_QUEUE_LENGTH          (1U)
#define PARENT_CALL_ALERT_SERVICE_DEFAULT_TASK_STACK_SIZE       (4096U)
#define PARENT_CALL_ALERT_SERVICE_DEFAULT_TASK_PRIORITY         (3U)
