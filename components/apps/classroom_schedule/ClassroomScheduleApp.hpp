...
private:
    ...
    void buildUrl(char *url, size_t url_size, const char *date) const;
    void urlEncode(const char *input, char *output, size_t output_size) const;
    ...
    static void classroomInputEventCb(lv_event_t *e);
